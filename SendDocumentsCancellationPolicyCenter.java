...
public class SendDocumentsCancellationPolicyCenter{
...
//private By cancellationEffectiveDate = By.id("StartCancellation:StartCancellationScreen:CancelPolicyDV:CancelDate_date-inputEl");
	...
	public void cancellationPolicy() throws InterruptedException, IOException {
		...
		cancelPolicy.click();
		 ...
		 Thread.sleep(2000);
		//START CANCELLETION BUTTON START MAIN FLOW  
		...
		//Go Back to RISK ANALISIS
	     ...
	     js.executeScript("arguments[0].scrollIntoView();",   confirmationReason);
	     System.out.println(confirmationReason.getText());
	     ...
	     boolean finalMessage = driver.findElement(By.id("JobComplete:JobCompleteScreen:JobCompleteDV:ViewPolicy-inputEl")).isDisplayed();
	     System.out.println(finalMessage); 
	     
	     Thread.sleep(2000);
	     
	     //Documents - click
	     WebElement documents = driver.findElement(By.xpath("/html/body/div[2]/div/div/div/div[3]/div[3]/div[1]/div/div/table[6]/tbody/tr/td/div/span"));
	     documents.click();
	     Thread.sleep(3000);
...
//	     Thread.sleep(3000);
	     ...
	     exec.executeScript("document.body.style.zoom = '0.67'");  // 67% Zoom
	     System.out.println("67% zoom done");
	     Thread.sleep(5000);
	     exec.executeScript("document.body.style.zoom = '1.00'"); // 100% Zoom
